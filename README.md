...
## Технології та мови:
1. Python/Flask - Використовувався для розробки серверної частини проекту.
2. FlaskMigrate/FlaskSQLAlchemy - Використовувався для роботи з базою даних через Python/Flask.
3. FlaskLogin - Використовувався для того щоб авторізовувати користувачів на сайт.
4. JavaScript - Використовувався для Frontend розробки. Робота з елементами сторінки та cookies.
5. HTML - Використовувався для структури сайту.
6. CSS - Використовувався для стилів сайту.
7. telebot - Використовувався для роботи з телеграм ботом.
8. requests - Використовувався для надсилання повідомлень від імені бота, але за межою додатку bot_app.
9. sqlite3 - Використовувався для роботи з базою даних через бота.
10. Figma - Використовувалавя для створення дизайну проекту.
11. Jinja - Використовувалавя для передачі даних з Python/Flask до HTML.
...
1. Розробляти власну, зручну структуру серверу.
